...
namespace ZeroFormatter.Formatters
{
    ...
    [Preserve(AllMembers = true)]
    internal class NullableValueTupleFormatter<TTypeResolver, T1> : Formatter<TTypeResolver, ValueTuple<T1>?>
        where TTypeResolver : ITypeResolver, new()
  
    {
        ...
        [Preserve]
        public NullableValueTupleFormatter()
        {
            this.formatter1 = Formatter<TTypeResolver, T1>.Default;
    ...
    [Preserve(AllMembers = true)]
    internal class NullableValueTupleFormatter<TTypeResolver, T1, T2> : Formatter<TTypeResolver, ValueTuple<T1, T2>?>
        where TTypeResolver : ITypeResolver, new()
    ...
    [Preserve(AllMembers = true)]
    internal class NullableValueTupleFormatter<TTypeResolver, T1, T2, T3> : Formatter<TTypeResolver, ValueTuple<T1, T2, T3>?>
        where TTypeResolver : ITypeResolver, new()
    ...
    [Preserve(AllMembers = true)]
    internal class NullableValueTupleFormatter<TTypeResolver, T1, T2, T3, T4> : Formatter<TTypeResolver, ValueTuple<T1, T2, T3, T4>?>
        where TTypeResolver : ITypeResolver, new()
    ...
    [Preserve(AllMembers = true)]
    internal class NullableValueTupleFormatter<TTypeResolver, T1, T2, T3, T4, T5> : Formatter<TTypeResolver, ValueTuple<T1, T2, T3, T4, T5>?>
        where TTypeResolver : ITypeResolver, new()
    ...
    [Preserve(AllMembers = true)]
    internal class NullableValueTupleFormatter<TTypeResolver, T1, T2, T3, T4, T5, T6> : Formatter<TTypeResolver, ValueTuple<T1, T2, T3, T4, T5, T6>?>
        where TTypeResolver : ITypeResolver, new()
    ...
    [Preserve(AllMembers = true)]
    internal class NullableValueTupleFormatter<TTypeResolver, T1, T2, T3, T4, T5, T6, T7> : Formatter<TTypeResolver, ValueTuple<T1, T2, T3, T4, T5, T6, T7>?>
        where TTypeResolver : ITypeResolver, new()
    ...
    [Preserve(AllMembers = true)]
    internal class NullableValueTupleFormatter<TTypeResolver, T1, T2, T3, T4, T5, T6, T7, TRest> : Formatter<TTypeResolver, ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>?>
        where TTypeResolver : ITypeResolver, new()
        where TRest : struct   
    {
        readonly Formatter<TTypeResolver, T1> formatter1;
